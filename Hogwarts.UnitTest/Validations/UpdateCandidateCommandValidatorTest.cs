...
{
    [TestFixture]
    public class UpdateCandidateCommandValidatorTest
    {
        private UpdateCandidateCommandValidator _validator;
        ...
        public void SetUp()
        {
            ...
            _validator = new UpdateCandidateCommandValidator(_candidateRepository.Object);
        }

        [Test]
        public void Should_have_error_when_identifier_not_unique()
        {
            var model = new UpdateCandidateCommand(2, new CandidateDto() { IdentificationNumber = 111111111 });
        ...
        {
            var model = new UpdateCandidateCommand(1,
                new CandidateDto() { IdentificationNumber = 111111113 });
        ...
        {
            var model = new UpdateCandidateCommand(1, new CandidateDto());
            var result = _validator.TestValidate(model);
        ...
        {
            var model = new UpdateCandidateCommand(1, new CandidateDto() { IdentificationNumber = 1111111112 });
